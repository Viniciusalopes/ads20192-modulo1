 ...
 *             Jhonathan dos Reis Santos Rosa
 *             Marcos Paulo P. da Paixão
...
public class Principal {
    ...
    private static String[] receitas = {"Leite ninho "};
    private static String[] ingredientes_massa;
    private static String[] ingredientes_leite_ninho;
    private static String[] ingredientes_dois_amores;
    private static String[] ingredientes_maracuja;

    private static int[] opcoes_menu_principal;
